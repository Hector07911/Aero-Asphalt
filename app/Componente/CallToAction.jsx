  ...
  return (
    <section className="w-full bg-black py-24 px-4 flex flex-col items-center justify-center min-h-screen">
      <div className="mx-auto max-w-4xl text-center">
        <div className="w-24 h-px bg-neutral-700 mx-auto mb-8"></div>
        <h1 className="text-white text-5xl md:text-7xl font-extrabold tracking-widest mb-6">
          AERO <span className="text-neutral-400">&</span> ASPHALT
        </h1>
        <h2 className="text-neutral-400 text-lg md:text-xl font-light tracking-widest mb-12 uppercase">
        ...
        <button className="border border-white text-white px-10 py-4 text-base font-medium tracking-widest hover:bg-white hover:text-black transition-all duration-300">
          <Link href="/coleccion">
            EXPLORAR COLECCIÓN
          </Link>
        </button>
        <div className="w-24 h-px bg-neutral-700 mx-auto mb-12"></div>
        <p className="text-[#C8C8C8] text-lg md:text-xl font-light tracking-widest mb-12 uppercase">
