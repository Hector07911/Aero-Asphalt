...
const ARTICLES = {
  'renacer-del-v12': {
    ...
    content: [
      ...
      { type: 'image', src: '/v12-2.jpg', alt: 'Motor V12', caption: 'Configuración V12 — Doce cilindros en perfecta armonía' },
      ...
      { type: 'image', src: '/v12-3.png', alt: 'Línea de tiempo V12', caption: 'De la F50 al DBS — Una línea de tiempo de leyendas' },
      {
        type: 'list',
        items: [
      ...
      { type: 'image', src: '/v12-lambo.jpg', alt: 'Sonido V12', caption: 'La firma sonora del V12 — Una melodía mecánica inconfundible' },
  ...
  'silueta-perfecta': {
    ...
    content: [
      ...
      { type: 'image', src: '/primerPorsche911.jpg', alt: 'Porsche 911 original', caption: 'El 911 original de 1963 — Una silueta que definiría una era' },
      ...
      { type: 'paragraph', text: 'Cada nueva versión incorporó avances tecnológicos, mejoras aerodinámicas y motores más eficientes, pero siempre respetando las proporciones que hicieron del 911 un icono.' },
      {
        ...
        { type: 'image', src: '/PorscheGT3.png', alt: 'Evolucionar sin olvidar el origen', caption: 'El Porsche 911 — Un legado que sigue evolucionando sin perder su personalidad' },
  ...
  'leyenda': {
    ...
    content: [
        ...
        { type: 'image', src: '/porsche-901.jpg', alt: 'Evolucionar sin olvidar el origen', caption: 'El Porsche 911 — Un legado que sigue evolucionando su ingeniería sin perder su icónica personalidad' },
